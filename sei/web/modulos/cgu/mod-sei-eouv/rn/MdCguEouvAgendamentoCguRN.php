...
class MdCguEouvAgendamentoCguRN extends InfraRN
{
    ...
    public function gravarLogLinha($numProtocolo, $idRelatorioImportacao, $mensagem, $sinSucesso)
    {
        ...
        $objEouvRelatorioImportacaoDetalheDTO->setStrDescricaoLog($mensagem);
    ...
    public function executarImportacaoManifestacaoEOuv()
    {
        ...
        $retornoWs = $objWS->GetListaManifestacaoOuvidoria(array("login" => '',
            "senha" => '', "numProtocolo" => '', "dataCadastroInicio" => $ultimaDataExecucaoFormatoEouv, "dataCadastroFim" => $dataAtualFormatoEOuv, "dataPrazoRespostaInicio" => '', "dataPrazoRespostaFim" => '', "situacaoManifestacao" => 1))->GetListaManifestacaoOuvidoriaResult;
            ...
            if ($idUltimaExecucao != null && $idUltimaExecucao != null) {
                ...
                if ($arrProtocolosProblematicos != null) {
                    foreach ($arrProtocolosProblematicos as $objProtocolosProblematicosDTO) {
                        ...
                        $retornoWsProblematicos = $objWS->GetListaManifestacaoOuvidoria(array("login" => 'rafael.ferreira@cgu.gov.br',
                            "senha" => 'R*afa1982', "numProtocolo" => InfraUtil::retirarFormatacao($objProtocolosProblematicosDTO->getStrProtocoloFormatado()), "dataCadastroInicio" => '', "dataCadastroFim" => '', "dataPrazoRespostaInicio" => '', "dataPrazoRespostaFim" => '', "situacaoManifestacao" => 1))->GetListaManifestacaoOuvidoriaResult;
    ...
    public function gerarPDFPedidoInicial($retornoWsLinha){
        ...
        $objProtocoloAnexoInicialDTO->setNumIdHipoteseLegal(null);
    ...
    public function gerarAnexosProtocolo($numProtocoloFormatado){
        ...
        $retornoWsAnexo = $objWSAnexo->GetAnexosManifestacao(array("login" => 'rafael.ferreira@cgu.gov.br',
            "senha" => 'R*afa1982', "numeroProtocolo" => InfraUtil::retirarFormatacao($numProtocoloFormatado)))->GetAnexosManifestacaoResult;
        ...
        foreach ($retornoWsAnexo->AnexosManifestacao as $retornoWsAnexoLista) {
            foreach ($this->verificaRetornoWS($retornoWsAnexoLista) as $retornoWsAnexoLinha) {
                ...
                try {
                    ...
                    $objProtocoloAnexoDTO->setNumIdHipoteseLegal(null);
